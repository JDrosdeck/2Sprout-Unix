...
**
** Created: Mon Jun 15 12:10:20 2009
...
public:
    ...
    void setupUi(QMainWindow *sproutClass)
    {
        ...
        groupBox->setGeometry(QRect(9, 9, 451, 301));
        textEdit = new QTextEdit(groupBox);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(13, 29, 431, 261));
...
"}"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/started.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/sprites_09.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_3->setIcon(icon3);
        groupBox_3 = new QGroupBox(page);
        groupBox_3->setObjectName(QString::fromUtf8("groupBox_3"));
        groupBox_3->setGeometry(QRect(10, 310, 451, 121));
        lineEdit_6 = new QLineEdit(groupBox_3);
        lineEdit_6->setObjectName(QString::fromUtf8("lineEdit_6"));
        lineEdit_6->setGeometry(QRect(290, 30, 113, 22));
        checkBox_3 = new QCheckBox(groupBox_3);
        checkBox_3->setObjectName(QString::fromUtf8("checkBox_3"));
        checkBox_3->setGeometry(QRect(230, 30, 51, 21));
        lineEdit_7 = new QLineEdit(groupBox_3);
        lineEdit_7->setObjectName(QString::fromUtf8("lineEdit_7"));
        lineEdit_7->setGeometry(QRect(70, 30, 113, 22));
        label_7 = new QLabel(groupBox_3);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(10, 30, 61, 17));
        checkBox_2 = new QCheckBox(groupBox_3);
        checkBox_2->setObjectName(QString::fromUtf8("checkBox_2"));
        checkBox_2->setGeometry(QRect(10, 60, 281, 21));
        stackedWidget->addWidget(page);
        page_2 = new QWidget();
        page_2->setObjectName(QString::fromUtf8("page_2"));
        groupBox_2 = new QGroupBox(page_2);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        groupBox_2->setGeometry(QRect(19, 9, 431, 241));
        ...
        label_4->setGeometry(QRect(10, 190, 41, 17));
        comboBox = new QComboBox(groupBox_2);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/db_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        lineEdit_3->setGeometry(QRect(130, 190, 61, 22));
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/db_host.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        groupBox_4->setGeometry(QRect(20, 260, 431, 161));
        textEdit_2 = new QTextEdit(groupBox_4);
        textEdit_2->setObjectName(QString::fromUtf8("textEdit_2"));
        textEdit_2->setGeometry(QRect(10, 30, 411, 121));
...
"}"));
    ...
    void retranslateUi(QMainWindow *sproutClass)
    {
        ...
        groupBox_3->setTitle(QApplication::translate("sproutClass", "Options/Networking", 0, QApplication::UnicodeUTF8));
        ...
        label_7->setText(QApplication::translate("sproutClass", "API Key", 0, QApplication::UnicodeUTF8));
